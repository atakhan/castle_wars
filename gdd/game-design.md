...
- **Прокладывание маршрута (pathfinding)**: движение персонажа к точке назначения с автоматическим обходом препятствий по построенному маршруту вместо прямолинейного движения «к цели» с учётом только коллизий (скольжение вдоль стен). Пока не реализовано.
