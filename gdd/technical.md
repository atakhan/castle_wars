...
1. **InputSystem** — для сущностей с InputController: если заданы targetX, targetY, вычисляет расстояние до цели. **Круг прибытия** (радиус 15 px): вне круга — полная скорость 200 px/s к цели; внутри круга — скорость пропорциональна расстоянию (`speed = 200 * (dist / 15)`), плавный подвод; при расстоянии &lt; 1 px — snap позиции в точку цели, обнуление скорости и сброс цели. Обновляет Direction из velocity при движении.
...
- Локальное состояние: x, y, vx, vy, direction; localTarget (цель движения или null). В ticker (60 FPS): если есть localTarget, та же логика круга прибытия, что на сервере — вне круга (радиус 15 px) полная скорость 200 px/s; внутри круга скорость пропорциональна расстоянию; при расстоянии &lt; 1 px — snap в точку, сброс цели. Затем `x += vx * dt`, `y += vy * dt`, разрешение коллизий circle vs AABB со статикой. Отрисовка своего персонажа — из локального состояния.
